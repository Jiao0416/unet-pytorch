...
def add_info_to_image(image, scale_factor=20, font_color=(0, 0, 0), colors=None, name_classes=None):
    ...
    font = ImageFont.truetype("Sarai.ttf", size=font_size)
...
class Unet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"    : 'logs/loss_2024_03_09_16_01_00/best_epoch_weights.pth',
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        "num_classes"   : 7,
    ...
    #   检测图片
    #---------------------------------------------------#
    def detect_image(self, image, count=False, name_classes=None, show_info=True):
        #---------------------------------------------------------#
